	...
	methods:{
        ...
        */
        toggleCate:function(index){
            ...
            (filterIndex===2)&&(this.price_isAsc=!thi.price_isAsc);
            this.sortBy(this.sortMethods[filterIndex].method);
        },
        /**
         * 根据属性值进行升序或降序的比较器
         * @method属性比较器
         * @param {string} prop属性名
         * @param {string} type 排序方法（desc降序，asc升序）
         */
